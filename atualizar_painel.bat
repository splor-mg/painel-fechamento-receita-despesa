...
git add Despesa_Orcamentaria_Fiscal_2027.csv Orcamento_Receita.csv repasse-recurso.csv Despesa_Intraorcamentaria_2027.csv "Limite Orçamentário.csv" data.json data_intra_patronal.json data_despesa_detalhada.json data_limite_orcamentario.json
